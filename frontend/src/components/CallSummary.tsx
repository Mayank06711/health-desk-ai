    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-xl border border-[#EEF2F7]">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-semibold text-[#263238]">Call Summary</h2>
        </div>
              ...
              <div className="space-y-2">
                {summary.appointments.map((appt, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-[#263238]">{appt.date}</span>
                    <Clock size={16} className="text-[#034C81]" />
                    <span className="text-sm text-[#263238]">{appt.time}</span>
                    <span
